...
export default function CourseCard({ course }) {
  // const courseLink = course?._id ? `/courses/${course._id}` : '/courses';
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl 
      ...
      <img
        src={course?.image}
        alt={course.title}
        className="w-full h-48 object-cover object-cover hover:scale-105 transition-transform duration-500"
      />
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <button
  className="
    mt-5 w-full text-white font-semibold py-2.5 rounded-lg 
